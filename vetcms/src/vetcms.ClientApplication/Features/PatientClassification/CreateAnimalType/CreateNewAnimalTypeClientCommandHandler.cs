...
namespace vetcms.ClientApplication.Features.PatientClassification.CreateAnimalType
{
    ...
    internal class CreateAnimalTypeApiCommandHandler : GenericApiCommandHandler<CreateAnimalTypeApiCommand, CreateAnimalTypeApiCommandResponse>
    {
        public CreateAnimalTypeApiCommandHandler(IServiceScopeFactory serviceScopeFactory)
